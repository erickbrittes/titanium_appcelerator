...
// in simulator we redefine to format for deCarta Developer console
...
{\
	NSString * exceptionName = [@"org.decarta." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.decarta";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIdeCartaNativeItemNone = -1, 
	UIdeCartaNativeItemSpinner = -2,
	UIdeCartaNativeItemProgressBar = -3,
	
	UIdeCartaNativeItemSlider = -4,
	UIdeCartaNativeItemSwitch = -5,
	UIdeCartaNativeItemMultiButton = -6,
	UIdeCartaNativeItemSegmented = -7,
	
	UIdeCartaNativeItemTextView = -8,
	UIdeCartaNativeItemTextField = -9,
	UIdeCartaNativeItemSearchBar = -10,
	
	UIdeCartaNativeItemPicker = -11,
	UIdeCartaNativeItemDatePicker = -12,
	
	UIdeCartaNativeItemInfoLight = -13,
	UIdeCartaNativeItemInfoDark = -14,
	
	UIdeCartaNativeItemDisclosure = -15,
	
	UIdeCartaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all deCarta instances of
