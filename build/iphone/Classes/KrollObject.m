...
//@interface deCartaObject : NSObject
//@end

@interface deCartaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[deCartaObject class]])
		{
			for (NSString *key in [[(deCartaObject*)o modules] allKeys])
			{
